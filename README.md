...
<ul>[Локальное развертывание](#Локально)</ul>
<ul>[Подключение к внешним источникам(HDFS, HIVE, S3)](#Подключение к внешним источникам)</ul>
<ul>[Подключение к ресурсным менеджерам(YARN, MESOS, K8S)](#Подключение к ресурсным менеджерам)</ul>
